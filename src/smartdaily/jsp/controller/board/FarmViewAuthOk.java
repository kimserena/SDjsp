...
/**
 * Servlet implementation class FarmViewAuthOk
 */
@WebServlet("/board/farm_view_auth_ok.do")
public class FarmViewAuthOk extends BaseController {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4904563186007811193L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (inquire_cate==null) {
			sqlSession.close();
			web.reredirect(null, "권한 변경 할 곳을 선택해 주세요.");
			return null;
		}
		...
		try {
			boardService.insertBoardFarmViewAuth(board);
		}catch(Exception e) {
			sqlSession.close();
		...
		web.reredirect(web.getRootPath() + "/board/daily_check.do", "권한변경 요청이 정상적으로 등록 되었습니다. 확인 후 조치 하겠습니다.");
