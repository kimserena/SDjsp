...
/**
 * Servlet implementation class SupportInsertOk
 */
@WebServlet("/board/support_insert_ok.do")
public class SupportInsertOk extends BaseController {

	
	/**
	 * 
	 */
	private static final long serialVersionUID = 4356851881970808832L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (inquire_cate==null) {
			sqlSession.close();
			web.reredirect(null, "문의 종류를 선택해 주세요.");
			return null;
		}
		...
		web.reredirect(web.getRootPath() + "/index.do", "문의가 정상적으로 등록 되었습니다.");
		/*
		 * String url = "%s/board/my_support_read.do?support_no=%d"; logger.debug("url",
		 * url); url = String.format(url, web.getRootPath(), board.getIdx());
		 * web.reredirect(url, "문의가 정상적으로 등록 되었습니다.");
		 */
