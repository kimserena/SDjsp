...
public class Notice extends BaseController {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6614019207784815780L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * if(web.getSession("loginInfo")==null) { web.reredirect(web.getRootPath() +
		...
		try {
			//전체 게시물 수
			totalCount = boardService.selectBoardNoticeCount(board);
			//나머지 페이지 번호 계산하기
