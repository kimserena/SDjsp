...
/**
 * Servlet implementation class UserEditOk
 */
@WebServlet("/users/user_edit_ok.do")
public class UserEditOk extends BaseController {

	/**
	 * 
	 */
	private static final long serialVersionUID = -7180876529484637036L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		web.reredirect(web.getRootPath() + "/index.do", "회원정보 수정이 완료 되었습니다.");
