...
/**
 * Servlet implementation class LocationsInfo
 */
@WebServlet("/admin/users/locations_info.do")
public class LocationsInfo extends BaseController {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4546116489894703882L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			buildingsList = buildingsService.selectBuildingsList(buildings);
		}catch (Exception e) {
		...
		return "admin/users/locations_info";
	}
