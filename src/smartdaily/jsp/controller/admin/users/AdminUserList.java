 ...
 */
@WebServlet("/admin/users/admin_user_list.do")
public class AdminUserList extends BaseController {

	
	/**
	 * 
	 */
	private static final long serialVersionUID = 8594631844989240294L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			// 전체 게시물 수 
			totalCount = usersService.selectUsersCount(users);
			// 나머지 페이지 번호 계산하기 
			...
			userList = usersService.selectAdminUserList(users);
		}catch(Exception e) {
		...
		return "admin/users/admin_user_list";
	}
