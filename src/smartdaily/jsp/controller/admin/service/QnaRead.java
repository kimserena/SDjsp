 ...
 */
@WebServlet("/admin/service/qna_read.do")
public class QnaRead extends BaseController {

	/**
	 * 
	 */
	private static final long serialVersionUID = -4758303386214642544L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(qna_no==0) {
			web.reredirect(null, "서비스문의 번호가 지정되지 않았습니다.");
			sqlSession.close();
			return null;
		}
		...
		try {
			readBoard = boardService.selectBoardService(board);
		}catch(Exception e) {
