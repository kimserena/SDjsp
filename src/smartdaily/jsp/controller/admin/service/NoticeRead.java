...
/**
 * Servlet implementation class NoticeRead
 */
@WebServlet("/admin/service/notice_read.do")
public class NoticeRead extends BaseController {

	/**
	 * 
	 */
	private static final long serialVersionUID = 4909338397547516383L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		return "admin/service/notice_read";
	}
