...
/**
 * Servlet implementation class NoticeInsertOk
 */
@WebServlet("/admin/service/notice_insert_ok.do")
public class NoticeInsertOk extends BaseController {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8959120840928896423L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/** (5) service를 통한 공지 등록  */
		try {
			boardService.insertBoardNotice(board);
		}catch(Exception e) {
