...
/**
 * Servlet implementation class AfterserviceList
 */
@WebServlet("/admin/service/afterservice_list.do")
public class AfterserviceList extends BaseController {

	/**
	 * 
	 */
	private static final long serialVersionUID = 8188857775755824211L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			asList = boardService.selectBoardAsList(board);
		}catch(Exception e) {
		...
		return "admin/service/afterservice_list";
	}
