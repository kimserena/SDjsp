...
/**
 * Servlet implementation class FarmViewAuthRead
 */
@WebServlet("/admin/service/farm_view_auth_read.do")
public class FarmViewAuthRead extends BaseController {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3290692389768171645L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(subscrip_no==0) {
			web.reredirect(null, "글 번호가 지정되지 않았습니다.");
			sqlSession.close();
			return null;
		}
		...
		try {
			readBoard = boardService.selectBoardFarmViewAuth(board);
		}catch(Exception e) {
		...
		return "admin/service/farm_view_auth_read";
	}
