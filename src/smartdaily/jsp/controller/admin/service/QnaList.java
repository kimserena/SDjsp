 ...
 */
@WebServlet("/admin/service/qna_list.do")
public class QnaList extends BaseController {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5688590632939892581L;
	...
	public String doRun(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			//전체 게시물 수
			totalCount = boardService.selectBoardServiceCount(board);
			//나머지 페이지 번호 계산하기
			...
			qnaList = boardService.selectBoardServiceList(board);
		}catch(Exception e) {
