        ...
        <div id="wrap">
                ...
                <div class="navbarbackg">
                        <div class="container">
                            <div class="navbar"> <a href="${pageContext.request.contextPath}/index.do"><i class="fas fa-home"></i></a>
                                ...
                                <div class="dropdown">
                                    <button class="dropbtn">문의 하기<i class="arrow down"></i> </button>
                                    <div class="dropdown-content"> <a href="${pageContext.request.contextPath}/board/notice.do">공지 사항</a> <a href="${pageContext.request.contextPath}/board/support.do" class="dropbtn-color">문의 하기</a> <a href="${pageContext.request.contextPath}/board/menual.do">매뉴얼</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div id="sub-visual-bg-basic">
                <div id="sub-visual">
                  ...
                  <form class="modal-join-content" method="post" action="${pageContext.request.contextPath}/board/support_insert_ok.do">
                ...
                document.getElementById("sample6_detailAddress").focus();
                                                    ...
                                                    <div class="form_col-50">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <div class="colgroup1">
                                                                    <label for="inquire_cate">문의 종류</label>
                                                                </div>
